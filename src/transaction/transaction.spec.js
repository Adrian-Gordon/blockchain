...
describe('Transaction', () => {
  ...
  it("throws an error if a transactiontype is not provided", (done) => {
    assert.throws(() =>  new Transaction({'consignmentid':'cabcdefg','datatype':'application/json','data':{"some":"arbitrary","json":"data"}, "publickey":publicKey}),Error,"transactiontype must be provided")
    done()

  })

  it("throws an error if an invalid transactiontype is  provided", (done) => {
    assert.throws(() =>  new Transaction({'consignmentid':'cabcdefg','transactiontype': 'feefoofi','datatype':'application/json','data':{"some":"arbitrary","json":"data"}, "publickey":publicKey}),Error,"transactiontype is not valid")
    done()

  })

  it("creates a transaction without a provided timestamp", (done) => {
    const transaction = new Transaction({'consignmentid':'cabcdefg','transactiontype':'despatched','datatype':'application/json','data':{"some":"arbitrary","json":"data"},"publickey":publicKey})
  ...
  it("creates a transaction with a provided integer timestamp", (done) => {
    const transaction = new Transaction({'consignmentid':'cabcdefg','transactiontype':'despatched','datatype':'application/json','data':{"some":"arbitrary","json":"data"},"publickey":publicKey,'timestamp':123456789})
  ...
  it("throws an error if an invalid timestamp is provided", (done) => {
    assert.throws(() => new Transaction({'consignmentid':'cabcdefg','transactiontype':'despatched','datatype':'application/json','data':{"some":"arbitrary","json":"data"},"publickey":publicKey,'timestamp':"A timestamp"}),Error, "timestamp must be an integer")
    done()
  })
